<template>
    ...
    >
        <div class="flex flex-col-reverse lg:flex-row-reverse">
            <div class="mx-2 my-1 px-3 py-1 text-blue-500 font-bold text-xl">
            ...
            <div class="mx-2 my-1 px-3 py-1 font-bold border text-gray-500">
                Username: {{ username }} | Name: {{ name }}
            </div>
            <div class="mx-3 text-left flex-auto">
              
                <button
                    @click="handleLogout()"
                    class="bg-blue-400 hover:bg-blue-600 px-5 py-2 mt-1 rounded text-white font-bold"
                >
                    Log Out
                </button>
