...
var render = function () {
  ...
  return _c("div", [
    _c("h1", { staticClass: "text-2xl font-bold underline" }, [
      _vm._v("\n         " + _vm._s(_vm.message) + "! ~~\n  "),
    ]),
  ])
}
